...
namespace {
struct qt_meta_tag_ZN13GraphicsSceneE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13GraphicsSceneE = QtMocHelpers::stringData(
    "GraphicsScene"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13GraphicsSceneE[] = {
...
Q_CONSTINIT const QMetaObject GraphicsScene::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13GraphicsSceneE.offsetsAndSizes,
    qt_meta_data_ZN13GraphicsSceneE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13GraphicsSceneE_t,
        // Q_OBJECT / Q_GADGET
...
void *GraphicsScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13GraphicsSceneE.stringdata0))
